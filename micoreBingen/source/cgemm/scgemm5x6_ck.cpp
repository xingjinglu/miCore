...
void gfxcoder::scgemm5x6_ck()
{
    ...
    v_mul_lo_u32(v3,ldb,v4);
    v_mul_lo_u32(v9,lda,v6);
    ...
    v_shl_b32(asld,v2,4);
    v_shl_b32(bsld,v3,4);
    s_shl_b32(s16,gidy,6);
    s_shl_b32(s17,slot,11);
    s_shl4_add_u32(col,slot,s16);
    v_shl_or_b32(csst,v3,8,asld);
    v_shl_or_b32(csld,v1,2,s17);

    VZERO32(c[0][0].x);
    s_sync(vmcnt(0));
    lsst_b128(sst,0x0000,apld+0);
    lsst_b128(sst,0x0800,bpld+0);
    lsst_b128(sst,0x1000,bpld+4);
...
__lable__(0);
    ...
    lsld_b128(b[1][0].x,bsld,0x0a00);
    lsld_b128(b[1][2].x,bsld,0x0b00);
    ...
    lsld_b128(b[1][0].x,bsld,0x0e00);
    lsld_b128(b[1][2].x,bsld,0x0f00);
    s_sync(lgkmcnt(4));
    V_MAC_F32(c[0][0].x,a[0][0].x,b[0][0].x);
    s_setprio(1);
    V_MAC_F32(c[0][0].y,a[0][0].x,b[0][0].y);
...
__lable__(1);
    for( int i=0; i<7; ++i ){
        ...
        lsld_b128(b[1^s][0].x,bsld,(i+1)*0x200+0x0800);
        lsld_b128(b[1^s][2].x,bsld,(i+1)*0x200+0x0900);
        s_sync(lgkmcnt(4));
