...
void gfxcoder::scgemm6x5_ck()
{
    ...
    const uint32_t ao  =v76;
    const uint32_t bo  =v78;
    const uint32_t sst =v79;
    const uint32_t asld=v80;
    const uint32_t bsld=v81;
    const uint32_t csst=v82;
    const uint32_t csld=v83;
    const uint32_t tidx=v84;
    ...
    v_mul_lo_u32(v9,lda,v4);
    v_mul_lo_u32(v3,ldb,v6);
    v_readlane0_b32(slot,v2);
    v_shl_add_u32(ao,v7,4,v9);
    v_shl_add_u32(bo,v8,4,v3);
...
__lable__(0);
    ...
    lsld_b128(b[1][0].x,bsld,0x1100);
    lsld_b128(b[1][2].x,bsld,0x1180);
    ...
    lsld_b128(b[1][0].x,bsld,0x1300);
    lsld_b128(b[1][2].x,bsld,0x1380);
    s_sync(lgkmcnt(4));
    V_MAC_F32(c[0][0].x,a[0][0].x,b[0][0].x);
    s_setprio(1);
    V_MAC_F32(c[0][0].y,a[0][0].x,b[0][0].y);
    ...
    lsld_b128(b[1][0].x,bsld,0x1500);
    lsld_b128(b[1][2].x,bsld,0x1580);
    s_sync(lgkmcnt(4));
    V_MAC_F32(c[0][0].x,a[0][0].x,b[0][0].x);
    s_setprio(1);
    V_MAC_F32(c[0][0].y,a[0][0].x,b[0][0].y);
    ...
    lsld_b128(b[0][0].x,bsld,0x1600);
    lsld_b128(b[0][2].x,bsld,0x1680);
    s_sync(lgkmcnt(4));
    V_MAC_F32(c[0][0].x,a[1][0].x,b[1][0].x);
    s_setprio(1);
    V_MAC_F32(c[0][0].y,a[1][0].x,b[1][0].y);
    ...
    lsld_b128(b[1][0].x,bsld,0x1700);
    lsld_b128(b[1][2].x,bsld,0x1780);
    s_sync(lgkmcnt(5));
    V_MAC_F32(c[0][0].x,a[0][0].x,b[0][0].x);
    s_setprio(1);
    V_MAC_F32(c[0][0].y,a[0][0].x,b[0][0].y);
...
__lable__(1);
    for( int i=0; i<7; ++i ){
        ...
        lsld_b128(b[1^s][0].x,bsld,(i+1)*0x100+0x1000);
        lsld_b128(b[1^s][2].x,bsld,(i+1)*0x100+0x1080);
        s_sync(lgkmcnt(4));
