...
void gfxcoder::sufbco8x5_om()
{
    ...
    const uint32_t sst =v77;
    const uint32_t csst=v78;
    const uint32_t csld=v79;
    const uint32_t tidx=v80;
    ...
    s_mul_i32(s14,n,ng);
    s_mul_i32(s15,k,ng);
    UFCO_COMPUTE_START_ADDR_AC(ao,co,m,s14,s15,tidx,dimx,mag,v4,s18,0);
    s_mul_i32(s3,s2,k);
    ...
    lsst_b32(sst,0x2000,bpld);
    s_sub_u32(k,k,ic(8));
    s_shl_b32(elda,m,5);
    s_shl_b32(eldb,s14,5);
