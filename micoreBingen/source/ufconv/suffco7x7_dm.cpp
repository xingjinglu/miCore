...
void gfxcoder::suffco7x7_dm( uint32_t mask )
{
    ...
    const uint32_t co  =v118;
    const uint32_t asld=v119;
    const uint32_t bsld=v120;
    const uint32_t asst=v121;
    const uint32_t bsst=v122;
    const uint32_t csst=v123;
    const uint32_t csld=v124;
    const uint32_t tidx=v125;
    ...
    s_mul_i32(s18,n,ng);
    s_mul_i32(s19,k,ng);
    UFCO_COMPUTE_START_ADDR_AC(ao,co,m,s18,s19,tidx,dimx,mag,v9,s14,1);
    ...
    v_shl_b32(v11,v5,4);
    v_mul_lo_u32(v12,m,v2);
    v_mul_lo_u32(v13,s19,v7);
    v_mul_lo_u32(v14,s19,v8);
    s_shl_b32(s3,m,4);
    v_shl_add_u32(ao+0,v12,2,ao );
    v_shl_add_u32(bo+0,v13,2,v11);
    v_shl_add_u32(bo+1,v14,2,v11);
