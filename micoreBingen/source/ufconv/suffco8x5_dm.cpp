...
void gfxcoder::suffco8x5_dm( uint32_t mask )
{
    ...
    const uint32_t bo  =v69;
    const uint32_t co  =v70;
    const uint32_t asld=v71;
    const uint32_t bsld=v72;
    const uint32_t asst=v73;
    const uint32_t bsst=v74;
    const uint32_t csst=v75;
    const uint32_t csld=v76;
    const uint32_t tidx=v77;
    ...
    s_sync(vmcnt(0));
    lsstx_b64x2(asst,0x0,apld+0,0x4,apld+2);
    lsstx_b64x2(asst,0x8,apld+4,0xc,apld+6);
