...
void gfxcoder::suffco7x4_qm( uint32_t mask )
{
    ...
    s_mul_i32(s22,k,ng);
    s_mul_i32(s23,n,ng);
    UFCO_COMPUTE_START_ADDR_A(ao,m,s22,v5,dimx,amag,v6,s16,2);
    v_shr_b32(v5,v0,3);
    v_and_b32(v6,ic(7),v0);
    v_or_b32(v7,col,v5);
    ...
    UFCO_COMPUTE_START_ADDR_C(co,m,s23,tidx,cmag,v7,s16,0);
    ...
    //asst=v0<<4
    //bsst=(v6<<6)|(v5<<2)
    //csst=(wave<<10)|(v4<<8)|(v3<<4)
    //csld=(wave<<10)|(v1<<2)
    s_shl_b32(s3,s2,10);
    v_and_b32(v3,ic(15),v1);
    v_shr_b32(v4,v1,4);
    v_shl_b32(v7,v3,4);
    v_shl_b32(v8,v5,2);
    v_shl_b32(bsld,v4,4);
    v_shl_b32(asst,v0,4);
    v_shl_or_b32(v9,v4,8,v7);
    v_shl_or_b32(asld,s2,8,v7);
    v_shl_or_b32(bsst,v6,6,v8);
