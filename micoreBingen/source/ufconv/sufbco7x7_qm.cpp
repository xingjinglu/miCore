...
void gfxcoder::sufbco7x7_qm()
{
    ...
    s_mul_i32(s16,k,ng);
    s_mul_i32(s17,n,ng);
    UFCO_COMPUTE_START_ADDR_A(ao,m,s16,v7,dimx,amag,v9,s18,2);
    s_mul_i32(s3,s2,k);
    ...
    v_mul_lo_u32(v7,m,v4);
    v_shl_b32(v8,v8,4);
    v_shl_add_u32(bo,v9,2,v8);
    v_shl_add_u32(bo+1,s17,5,bo);
    ...
    UFCO_COMPUTE_START_ADDR_C(co,m,s17,ro,cmag,v7,s18,1);
    ...
    v_shl_b32(sst,v0,4);
    s_shl_b32(xlda,m,6);
    s_shl_b32(xldb,s17,6);
    s_shl_b32(s13,s12,11);
    s_shl4_add_u32(col,s12,s23);
