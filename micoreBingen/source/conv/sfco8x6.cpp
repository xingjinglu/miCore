...
void gfxcoder::sfco8x6( uint32_t mask )
{
    ...
    v_cmov_b32(v8,v7,v8);
    v_shl_b32(v9,v5,3);
    v_mul_lo_u32(v10,ldb,v8);
    v_shl_add_u32(bo,v10,2,v9);
    s_sync(lgkmcnt(0));
    ...
    v_shl_b32(bsld,v4,4);
    v_shl_b32(asst,v0,2);
    v_shl_or_b32(v10,v4,8,v7);
    v_shl_or_b32(asld,v2,8,v7);
    v_shl_or_b32(bsst,v5,8,v8);
    v_shl_or_b32(csld,v2,11,v9);
    v_shl_or_b32(csst,v2,11,v10);
