...
void gfxcoder::sfft4x4_r2c_perm_pad( uint32_t pad_y )
{
    uint2 c[12];
    ...
    s_and_b32(pad_x,ic(15),pad_x);
    s_mov_b32(s13,gidx);
    s_cmpk_u32(s12,0,eq);
    s_cmov_b32(bx,gidy);
    s_csel_b32(by,s13,gidy);
    v_shl_or_b32(icell,bx,4,y);
    v_mul_lo_u32(v20,ldx,icell);
    s_shl_b32(s14,by,2);
    S_MUL_U64_U32(s12,ldy,s14);
    S_ADD_U64(rbase,rbase,s12);
    v_sub_i32(px,x,pad_x);
    v_add_shl_u32(rvo,v20,px,2);
    FFT16x16_R2C_LDR_PAD(c,rbase,rvo,px,icell,ncells,nx,ny,pad_y);
