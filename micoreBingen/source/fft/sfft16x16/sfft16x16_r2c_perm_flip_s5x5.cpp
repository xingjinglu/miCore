...
void gfxcoder::sfft4x4_r2c_qerm_s5x5()
{
    uint2 c[12];
    ...
    ldg_b32(c[0].x,rbase,v3,0x50);
    ldg_b32(c[0].y,rbase,v3,0x3c);
    ldg_b32(c[1].x,rbase,v3,0x28);
    ldg_b32(c[1].y,rbase,v3,0x14);
    ldg_b32(c[2].x,rbase,v3,0x00);
    s_mov_b64(exec,s8);
