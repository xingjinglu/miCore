...
void gfxcoder::sfft4x4_r2c_grid_perm_ex()
{
    uint2 c[12];
    ...
    const uint32_t xo     =v21;
    const uint32_t yo     =v23;
    ...
    v_mul_lo_u32(v27,ldx,imap);
    v_mul_u24(xo,tile_x,icell_x);
    v_mul_u24(yo,tile_y,icell_y);
    v_add_u32(xo,xo,x);
    v_mad_u24(v28,nx,yo,v27);
    v_sub_u32(yo,ny,yo);
    v_add_shl_u32(rvo,v28,xo,2);
    S_MUL_U64_U32(s8,s22,ldy);
    S_ADD_U64(rbase,rbase,s8);
    //==================================================================
    FFT16x16_R2C_LDR_SPLIT_EX(c,rbase,rvo,xo,yo,icell,ncells,nx);
