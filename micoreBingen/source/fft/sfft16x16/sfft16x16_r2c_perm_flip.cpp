...
void gfxcoder::sfft4x4_r2c_perm_flip( uint32_t mask )
{
    ...
    v_add_u32(v21,ic(1),x);
    v_sub_u32(v20,s13,v21);
    v_add_shl_u32(rvo,v19,v20,2);
    FFT16x16_R2C_LDR_FLIP(c,rbase,rvo,x,icell,ncells,nx,ny);
