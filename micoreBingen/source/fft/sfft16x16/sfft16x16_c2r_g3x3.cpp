...
void gfxcoder::sfft4x4_c2r_g3x3()
{
    uint2 c[12];
    ...
    //if((icell<pnc)&&(tid<144)){ d_r[tid]=smem[tid] }
    //===========================================================
    ...
    s_cmov_b32(s8,s9);
    v_mad_u24(v17,ic(9),y,flipx);
    v_shl_b32(v16,v17,2);
    v_cmp_u32(ic(3),flipx,gt);
    s_barrier();
    s_andexec_b64(s0,vcc);
    lsst_b32(v16,0x00,c[0].x);
    lsst_b32(v16,0x0c,c[0].y);
    lsst_b32(v16,0x18,c[4].x);
