...
void gfxcoder::sfft5x5_c2r_g7x7()
{
    uint2 c[24];
    ...
    //if((256+tid)<n){ d_r[256+tid]=smem[256+tid] }
    //===========================================================
    ...
    s_cmov_b32(s8,s9);
    v_mad_u24(v33,ic(49),y,flipx);
    v_shl_b32(v32,v33,2);
    v_cmp_u32(ic(7),flipx,gt);
    s_barrier();
    s_andexec_b64(s0,vcc);
    lsst_b32(v32,0x00,c[ 0].x);
    lsst_b32(v32,0x1c,c[ 0].y);
    lsst_b32(v32,0x38,c[ 8].x);
    lsst_b32(v32,0x54,c[ 8].y);
    lsst_b32(v32,0x70,c[ 4].x);
    lsst_b32(v32,0x8c,c[ 4].y);
    lsst_b32(v32,0xa8,c[12].x);
