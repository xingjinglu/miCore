...
/*args : d_c, ldc, bks, d_r, nc, nx, ldx, ldy, grid, tile, xmagic, xshift, ymagic, yshift, ny, pad*/

void gfxcoder::sfft5x5_r2c_grad_pad()
{
    uint2 c[24];
    ...
    v_add_i32(ox,sox,x);
    v_add_shl_u32(rvo,v38,ox,2);
    //======================================================================
    FFT32x32_R2C_XLDR_PAD(c,rbase,rvo,ox,soy,chn,nc,nx,ny);
