...
void gfxcoder::sfft5x5_c2r_g5x5()
{
    uint2 c[24];
    ...
    //m=pnc*25-gidx*200
    //n=gidx<nb-1?200:m
    //if(flipx<5){ smem[y*25+flipx]=c[i] } sync
    ...
    s_cmov_b32(s8,s9);
    v_mad_u24(v33,ic(25),y,flipx);
    v_shl_b32(v32,v33,2);
    v_cmp_u32(ic(5),flipx,gt);
    s_barrier();
    s_andexec_b64(s0,vcc);
    lsst_b32(v32,0x00,c[0].x);
    lsst_b32(v32,0x14,c[0].y);
    lsst_b32(v32,0x28,c[8].x);
    lsst_b32(v32,0x3c,c[8].y);
    lsst_b32(v32,0x50,c[4].x);
