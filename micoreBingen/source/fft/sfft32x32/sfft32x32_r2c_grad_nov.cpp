...
void gfxcoder::sfft5x5_r2c_grad_nov()
{
    uint2 c[24];
    ...
    const uint32_t vax    =v33;
    const uint32_t chn    =v34;
    ...
    s_sub_u32(s10,grid_x,ic(1));
    s_sub_u32(s11,grid_y,ic(1));
    s_sub_u32(s8,nx,sox);
    s_sub_u32(s9,ny,soy);
    s_cmp_u32(cell_x,s10,eq);
    s_cmov_b32(tile_x,s8);
    s_cmp_u32(cell_y,s11,eq);
    s_cmov_b32(tile_y,s9);
    v_add_shl_u32(rvo,v38,x,2);
    //==================================================================
    FFT32x32_R2C_XLDR_NOV(c,rbase,rvo,x,tile_x,tile_y,chn,nc,nx);
