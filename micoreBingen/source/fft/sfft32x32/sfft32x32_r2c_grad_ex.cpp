...
/*args : d_c, ldc, bks, d_r, nc, nx, ldx, ldy, grid, tile, xmagic, xshift, ymagic, yshift, ny*/

void gfxcoder::sfft5x5_r2c_grad_ex()
{
    uint2 c[24];
    ...
    //==================================================================
    FFT32x32_R2C_XLDR_EX(c,rbase,rvo,ox,ny,chn,nc,nx);
