...
void gfxcoder::sgemm7x5()
{
    ...
    //bbase+=gidz*bbks, bo=v6*ldb+(v8<<3)
    ...
    //csld=(slot<<11)|(v1<<3)
    //col=(gidy<<5)|(slot<<4)
    s_shl_b32(gidy,gidy,5);
    s_shl_b32(s9,s2,11);
    s_shl4_add_u32(col,s2,gidy);
    v_shl_b32(asst,v0,4);
    v_shl_b32(bsst,v0,3);
    v_shl_b32(asld,v5,4);
    v_shl_b32(bsld,v6,4);
    v_shl_or_b32(csst,v6,9,asld);
    v_shl_or_b32(csld,v1,3,s9);
...
__lable__(0);
    ...
    for( int i=0; i<4; ++i )
    {
        ...
        if(i==0){
            ...
            S_ADD_U64_U32(s2,s0,s16);
            S_ADD_U64_U32(s4,s2,s16);
            S_ADD_U64_U32(s6,s4,s16);
        } else {
            S_ADD_U64_U32(s0,s0,s17);
            S_ADD_U64_U32(s2,s2,s17);
            S_ADD_U64_U32(s4,s4,s17);
            S_ADD_U64_U32(s6,s6,s17);
        }
        s_sync(lgkmcnt(0));
        s_mov_b64(exec,s10);
